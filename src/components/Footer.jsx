export default function Footer() {
  ...
  const socialLinks = [
    { name: "Instagram", href: "https://instagram.com/diagonal.studio" },
    { name: "Twitter", href: "https://twitter.com/diagonal_studio" },
    { name: "LinkedIn", href: "https://linkedin.com/company/diagonal-studio" },
    { name: "Behance", href: "https://behance.net/diagonal-studio" },
  ];
    ...
    <footer className="bg-pantone-black text-white pt-16 pb-8 px-6 select-none">
          ...
          <ul className="font-monument text-3xl md:text-4xl leading-tight space-y-2">
            {navLinks.map((link) => (
              <li key={link.name}>
                <a
                  href={link.href}
                  className="hover:text-pantone-283 transition"
                >
                  {link.name}
                </a>
              </li>
      ...
      <div className="mt-16 border-t border-white/20 pt-4 flex flex-col md:flex-row justify-between items-center gap-4 text-white/80 font-museo text-lg">
        ...
        <div className="w-full md:w-auto text-right flex items-center gap-2">
          <a href="#top" className="hover:text-white font-museo transition">
            Back to top
          </a>
          <svg
