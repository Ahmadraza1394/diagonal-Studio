              ...
              >
                ...
                {project.virtualTour && (
                  <div className="mt-8 md:mt-12">
                    <h3 className="font-monument uppercase text-2xl md:text-3xl text-pantone-black mb-6 font-bold after:content-[''] after:block after:w-16 after:h-1 after:bg-pantone-7515 after:mt-2">
                      Tour Virtual 360°
                    </h3>
                    <div
